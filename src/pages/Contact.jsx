        ...
        <div className="contact__grid">
          ...
          <div className="contact__left">
            ...
            <div className="contact__delivery-card card">
              ...
              <div className="contact__delivery-row">
                <span>📅 Days</span>
                <strong>{DELIVERY_INFO.days}</strong>
              </div>
              <div className="contact__delivery-row">
                <span>🕐 Timing</span>
                <strong>{DELIVERY_INFO.timing}</strong>
              </div>
              <p className="contact__delivery-note">{DELIVERY_INFO.note}</p>
            </div>

            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="contact__insta-card">
